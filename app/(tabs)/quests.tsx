        ...
        {QUESTS.map((quest) => (
          <View
            ...
            style={{
              ...
              overflow: 'hidden',
              borderWidth: 1,
              borderColor: quest.highlighted ? 'rgba(255, 170, 184, 0.2)' : '#F1E6E8',
              boxShadow: '0 8px 18px rgba(255, 170, 184, 0.12)',
              borderCurve: 'continuous',
            }}>
            <Image source={{ uri: quest.image }} contentFit="cover" style={{ height: 170, width: '100%' }} />
            <View style={{ padding: 20, gap: 8 }}>
                  ...
                  {quest.category ? (
                    <Text
                      ...
                      style={{
                        ...
                        fontWeight: '700',
                        letterSpacing: 2,
                        color: quest.highlighted ? '#332D2E' : 'rgba(51, 45, 46, 0.6)',
                        fontFamily: Fonts.rounded,
                      }}>
                      {quest.category}
                    </Text>
              ...
              <View
                ...
                <Text
                  ...
                  style={{
                    fontSize: 12,
                    color: quest.highlighted ? '#5C5254' : 'rgba(51, 45, 46, 0.6)',
                    fontFamily: Fonts.rounded,
                  }}>
                  {quest.energy}
                </Text>
                <Pressable
                  ...
                  <Text
                    selectable
                    style={{ color: '#FFFFFF', fontSize: 12, fontWeight: '700', fontFamily: Fonts.rounded }}>
                    達成！
                  </Text>
                </Pressable>
              </View>
