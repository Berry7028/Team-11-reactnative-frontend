    ...
    <ScrollView
        ...
        {ACTIONS.map((action) => (
          <View
            ...
            style={{
              ...
              borderRadius: 999,
              backgroundColor: action.active ? '#A8DF8E' : 'rgba(255,255,255,0.65)',
              flexDirection: 'row',
              alignItems: 'center',
              gap: 6,
              borderWidth: 1,
              borderColor: action.active ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.4)',
              boxShadow: '0 2px 8px rgba(58, 77, 57, 0.12)',
              borderCurve: 'continuous',
            }}>
            <IconSymbol name={action.icon} size={18} color={action.active ? '#FFFFFF' : '#3A4D39'} />
            <Text
              selectable
              style={{
                fontSize: 12,
      ...
      <View
        ...
        <View
          ...
          <IconSymbol name="person.3.fill" size={16} color="rgba(58, 77, 57, 0.6)" />
          <Text
            selectable
            style={{
              fontSize: 12,
